...
function Home() {
  ...
  const handleIconClick = (action) => {
    ...
    switch (action) {
      case 'edit':
        message = "Sorry, we don't have an API to edit.";
        break;
      case 'flag':
        message = "Sorry, we don't have an API to flag.";
        break;
      case 'delete':
        message = "Sorry, we don't have an API to delete.";
        break;
      default:
        message = '';
    }
            ...
            <Card sx={{ minHeight: 250, position: 'relative', bgcolor: 'darkorchid', color: 'white' }}>
              <CardContent sx={{ textAlign: 'center', paddingTop: '15%' }}>
                ...
                <Box sx={{ position: 'absolute', top: 8, right: 8 }}>
                  <IconButton size="small" onClick={() => handleIconClick('edit')}>
                    <EditIcon sx={{ color: '#eed3f5' }} />
                  </IconButton>
                  <IconButton size="small" onClick={() => handleIconClick('flag')}>
                    <FlagIcon sx={{ color: '#eed3f5' }} />
                  </IconButton>
                  <IconButton size="small" onClick={() => handleIconClick('delete')}>
                    <DeleteIcon sx={{ color: '#eed3f5' }} />
                  </IconButton>
                </Box>
                <Button 
                  variant="outlined" 
